...
(function () {
    ...
    fluid.oldRenderer = function (templates, tree, options, fossilsIn) {
        ...
        options.jQuery = options.jQuery || jQuery;
        ...
        outDecoratorsImpl = function (torender, decorators, attrcopy, finalID) {
            ...
            for (var i = 0; i < decorators.length; ++i) {
                ...
                // honour these remaining types immediately
                    ...
                    var fakeNode = jQuery("<div>", {"class": attrcopy["class"]})[0];
        ...
        function dumpBranchHead(branch, targetlump) {
            ...
            var attrcopy = {};
            jQuery.extend(true, attrcopy, targetlump.attributemap);
        ...
        function renderComponentSystem(context, torendero, lump) {
            ...
            var uselump = lump;
            var attrcopy = {};
            jQuery.extend(true, attrcopy, (payload === null ? lump : payload).attributemap);
    ...
    jQuery.extend(fluid.oldRenderer, fluid.renderer, renderer);
